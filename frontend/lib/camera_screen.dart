...
class _CameraScreenState extends State<CameraScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _trashName = _t(titleKey) != titleKey
              ? _t(titleKey)
              : 'AI Limit Reached';
          _trashMessage = _t(msgKey) != msgKey
              ? _t(msgKey)
  ...
  void _navigateToSearch() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => SearchScreen(initialLang: _lang)),
    );
  }

  @override
  Widget build(BuildContext context) {
    Color themeColor = _trashType != null
        ? _getTrashColor(_trashType!)
        : Colors.green;
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color:
                                  (_showSearchButton ? Colors.red : themeColor)
                                      .withOpacity(0.2),
                              blurRadius: 15,
                              offset: const Offset(0, 5),
                            ),
                      ...
                      if (_collectionSchedule != null &&
                          _collectionSchedule!.isNotEmpty)
                        Container(
                          padding: const EdgeInsets.symmetric(
                            vertical: 16,
                            horizontal: 20,
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _t('next_collection') != 'next_collection'
                                          ? _t('next_collection')
                                          : "Next Collection",
                                      style: TextStyle(
                                        color: Colors.grey[600],
